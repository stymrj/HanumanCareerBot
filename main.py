...
daily_schedule = [
    ...
    ("03:24", "🛕 *Ab shuru ho pooja!* Hanuman ji ko smaran karke prarthna kijiye. Commands: /chalisa /mantra /bajrangbaan"),
    ("03:25", "🌸 *Pooja ho gayi?* To lo ek achha vichar:\n_“Sankat mochan naam tiharo, sumirat hoye anand.”_"),
    ("03:26", "📈 *Career Tip Time:*\nAaj resume bhejna, interview prep karna aur ek naya skill seekhna target rakho!"),
